...
/* F05 settings
 #define SET_LEFT_FAWAD
	(uns16)2115  // 2115 ticks for 1 ms
 #define SERVO_1_5MS	(uns16)3172  // 3172 ticks for 1.5 ms
 #define SET_RIGHT_FAWAD	(uns16)4230  // 4230 ticks for 2 ms
*/

// F06 settings (to be customized by each group)
#define SET_LEFT_FAWAD	(uns16)2500  // 2500 ticks for 1 ms
#define SERVO_LEFT_STOP	(uns16)3490  // 3750 ticks for 1.5 ms
#define SERVO_RIGHT_STOP (uns16)3500  // 3750 ticks for 1.5 ms
#define SET_RIGHT_FAWAD	(uns16)4250  // 5000 ticks for 2 ms
...
#define  UseServos \
    servo_on_bit = 1;
#define  LeftServoOn \
    SetLeft(SET_LEFT_FAWAD)
);
#define  LeftServoOff \
    SetLeft(SERVO_LEFT_STOP);
#define  RightServoOn \
    SetRight(SET_RIGHT_FAWAD);
